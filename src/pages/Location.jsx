...
import { getWindDirection } from "../utils/formatWeather.js";

import { formatDay, formatTime } from "../utils/formatWeather.js";
...
function Location() {
  ...
  // From saved location link - 

  const { cityname } = useParams();

  useEffect(() => {
    if (cityname) {
      setSelectedCity(decodeURIComponent(cityname))
    }
  }, [cityname])
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-t from-white to-blue-400 pb-28">
      <div className="flex flex-col gap-8 px-4 py-8">
        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div onClick={() => {
            saveLocation(currentWeather, setToast)
          }} className="p-3 bg-white rounded-2xl shadow-sm cursor-pointer text-xl">
            <RiHeartAdd2Line />
          </div>
        ...
        <form
          ...
          className="flex justify-between items-center gap-0 bg-white rounded-full p-4 px-6"
        >
          <input
            ...
            <div className="min-h-screen bg-transparent pb-10">
              <div className="flex flex-col gap-8 px-2 py-8">
                ...
                <div className="w-full flex justify-center items-center">
                  <div className="flex flex-col items-center justify-center">
                    <h2 className="text-lg sm:text-4xl font-bold text-gray-800">
                      {currentWeather?.name}
                    </h2>
                    <h2 className="text-sm text-gray-500 sm:text-2xl">
