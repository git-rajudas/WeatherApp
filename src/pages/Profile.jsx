        ...
        <div className="flex flex-col gap-8 px-6 py-8 ">
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <div className="flex flex-col items-center justify-center">
              <h2 className="text-lg sm:text-2xl font-semibold text-black">Profile</h2>
            </div>
          ...
          <div className="flex flex-col justify-center items-center gap-5 sm:w-[50%] sm:ml-20 sm:mr-30 sm:p-20 sm:bg-amber-50 sm:bg-white sm:rounded-3xl  sm:shadow-xl">
            {/* PROFILE IMAGE */}
            <div className="relative w-[100px] h-[100px] sm:w-[150px] sm:h-[150px]">
              ...
              <div onClick={displayUploadImage}
                className="
                        absolute 
                        bottom-0 
                        right-0 
            ...
            <div className="flex flex-col items-center gap-1">
              <div className="text-xl sm:text-3xl font-semibold">{profile?.full_name}</div>

              <div className="text-gray-500 sm:text-xl">Kolkata, IN</div>
            </div>

            <div className="relative overflow-hidden bg-white w-full rounded-[35px] p-6 flex flex-col justify-center items-center gap-2 md:shadow-xl">
          ...
          <div className="flex flex-col justify-between items-start gap-4 sm:w-[50%] sm:mr-20">
            ...
            <div className="text-xl font-semibold items-start-safe">
              Account
            </div>
            ...
            <div className="bg-white w-full rounded-3xl p-6 flex flex-col justify-center items-center gap-2 shadow-xl">
              <div className="flex items-center justify-center w-full gap-2 cursor-pointer">
                <div className="text-red-600 font-semibold" onClick={handleLogout}>Log Out</div>
